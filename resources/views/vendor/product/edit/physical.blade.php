    ...
    @if (!empty($catAttributes))
        @foreach ($catAttributes as $catAttribute)
            <div class="row">
                ...
                <div class="col-lg-12">
                    @php $i = 0; @endphp
                    @foreach ($catAttribute->attribute_options as $option)
                        @php
                                    ...
                                    <div class="col-10">
                                        <div class="price-container">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ ($checked && !empty($selectedAttrs[$inName]['prices'][$i])) ? round($selectedAttrs[$inName]['prices'][$i] * $sign->value, 2) : '' }}"
                                            >
                                        </div>
                                    </div>
                                </div>
